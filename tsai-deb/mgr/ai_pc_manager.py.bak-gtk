...
class AIManager:
    ...
    @classmethod
    def stop_all(cls):
        """Kill all currently running subprocesses started by this manager."""
    ...
    def _track(cls, proc):
        with cls._active_lock:
            cls._active_procs.append(proc)

    @classmethod
    def _untrack(cls, proc):
        with cls._active_lock:
            try:
                cls._active_procs.remove(proc)
            except ValueError:
                pass
...
class MainWindow(Gtk.ApplicationWindow):
    def __init__(self, app):
        ...
        hb.set_title_widget(Gtk.Label(label="AI电脑管家"))
...
def main():
    if chstyle:
        chstyle.apply_gtk4()
    GLib.set_prgname("com.aipc.manager")
    app = AIApplication()
